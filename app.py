...
logging_filename = f'SheetExtractor_{timestamp}.log'
...
demo = gr.Interface(
    ...
    outputs=gr.File(label="Download Bookmarked PDF"),
    title="Autobookmark",
    description="Upload a PDF and get it back with Gemini-powered bookmarks.")
